...
export default function FeaturePage() {
  const items = [
    { t: "CVE-2026-0142 — Critical RCE in Node.js", d: "Affects: v18-v20 • CVSS: 9.8 • Patch available • Your status: Vulnerable", s: "critical" },
    { t: "New phishing campaign targeting SaaS admins", d: "Vector: OAuth consent screen • Region: US/EU • Confidence: High", s: "warning" },
    { t: "Supply chain attack on npm package", d: "Package: event-stream-fork • Downloads: 50K/week • Status: Removed", s: "critical" },
    { t: "Zero-day in popular WAF bypassed", d: "Vendor: Cloudflare • Status: Patched • Your status: Protected", s: "resolved" }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white border-b px-6 py-3 flex items-center gap-4">
        ...
        <h1 className="font-bold">Threat Intelligence</h1>
      </header>
      <div className="max-w-4xl mx-auto px-6 py-8">
        <p className="text-gray-500 text-sm mb-6">Latest security threats relevant to your stack</p>
