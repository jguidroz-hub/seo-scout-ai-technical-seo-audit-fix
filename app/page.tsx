  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">SEO Scout - AI Technical SEO Audit & Fix</h1>
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">Value Proposition: Helps SEO professionals and digital marketers efficiently identify, prioritize, and suggest actionable fixes for technical SEO issues across websites, saving significant time and improving search engine rankings.
...
Promotion Type: automatic</p>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-gray-600 mb-6">Join thousands of small businesses who trust SEO Scout - AI Technical SEO Audit & Fix.</p>
      ...
      <footer className="border-t py-8">
        <div className="max-w-4xl mx-auto px-6 flex justify-between text-sm text-gray-500">
          <p>© {new Date().getFullYear()} SEO Scout - AI Technical SEO Audit & Fix. All rights reserved.</p>
